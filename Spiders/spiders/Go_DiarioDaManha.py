...
main_url = "https://www.dm.com.br/ultimas-noticias/page/1/"
...
class GoDiarioDaManha(scrapy.Spider):
    ...
    start_urls = ["https://www.dm.com.br/ultimas-noticias/page/1/"]
    INCREMENT = 0
    ...
    def parse(self, response):
        ...
        self.INCREMENT += 20
        next_page = f"https://www.dm.com.br/ultimas-noticias/page/{self.INCREMENT}/"
    ...
    def parse_article(self, response):
        ...
        match = re.search(r"(\d{1,2} de \w+ de \d{4})", updated)
