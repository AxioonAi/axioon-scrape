...
with open(f"/home/scrapeops/axioon-scrape/Init_Apify/Results/TikTok/TikTok_Posts_Urls.json") as f:
...
with open(f"/home/scrapeops/axioon-scrape/Init_Apify/Results/TikTok/TikTok_Comments.json", "w", encoding="utf-8") as f:
    f.write(json_str)
    
upload_file(f"/home/scrapeops/axioon-scrape/Init_Apify/Results/TikTok/TikTok_Comments.json", "axioon", f"Apify/TikTok/Comments/TikTok_Comments_{timestamp}.json")
