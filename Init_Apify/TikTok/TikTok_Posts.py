...
with open(f"/home/scrapeops/axioon-scrape/Init_Apify/Results/TikTok/TikTok_Posts.json", "w", encoding="utf-8") as f:
    f.write(json_str)

with open(f"/home/scrapeops/axioon-scrape/Init_Apify/Results/TikTok/TikTok_Posts_Urls.json", "w", encoding="utf-8") as f:
    f.write(posts_str)

upload_file(f"/home/scrapeops/axioon-scrape/Init_Apify/Results/TikTok/TikTok_Posts.json", "axioon", f"Apify/TikTok/Posts/TikTok_Posts_{timestamp}.json")
