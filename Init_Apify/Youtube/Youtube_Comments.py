...
with open("Init_/Results/Youtube/Youtube_Comments.json", "w", encoding="utf-8") as f:
    f.write(json_str)
    
upload_file("Init_/Results/Youtube/Youtube_Comments.json", "axioon", f"Apify/YouTube/Comments/YouTube_Comments_{timestamp}.json")
