...
with open ("Apify/Results/Instagram/Instagram_Mentions.json", "w", encoding="utf-8") as f:
    f.write(json_str)

with open("Apify/Results/Instagram/Instagram_Mentions_Urls.json", "w", encoding="utf-8") as f:
    f.write(posts_str)
