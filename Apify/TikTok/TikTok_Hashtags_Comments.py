...
with open(f"Apify/Results/TikTok/TikTok_Hashtags_Urls.json") as f:
...
with open(f"Apify/Results/TikTok/TikTok_Hashtags_Comments.json", "w", encoding="utf-8") as f:
    f.write(json_str)
    
upload_file(f"Apify/Results/TikTok/TikTok_Hashtags_Comments.json", "axioon", f"Apify/TikTok/Comments/TikTok_Hashtags_Comments_{timestamp}.json")
