...
with open("/home/scrapeops/axioon-scrape/Apify/Results/Facebook/Facebook_Posts.json", "w", encoding="utf-8") as f:
    f.write(json_str)
    
with open("/home/scrapeops/axioon-scrape/Apify/Results/Facebook/Facebook_Posts_Urls.json", "w", encoding="utf-8") as f:
    f.write(posts_str)
    
upload_file("/home/scrapeops/axioon-scrape/Apify/Results/Facebook/Facebook_Posts.json", "axioon", f"Apify/Facebook/Posts/Facebook_Posts_{timestamp}.json")
